...
function hasOddNumber(arr) {
    ...
    return arr.some(function (fxinVal) {
        return fxinVal % 2 === 1;
    })
...
function hasAZero(num) {
    ...
    return (num + " ").split("").some(function (fxinChar) {
        return fxinChar === "0";
    })
...
true if every single number in the array is odd. If any of the values in the array are not odd, the function should return false. 
...
function hasOnlyOddNumbers(arr) {
    ...
    return arr.every(function (fxinNum) {
        return fxinNum % 2 === 1;
    })
...
true if there are no duplicate values (more than one element in the array that has the same value as another). If there are any duplicates, the function should return false.
...
function hasNoDuplicates(arr) {
    ...
    // short way -- use ... new Set to create a new array and if the lengths match, there are no dups.
    ...
    // 3 left turns
    return arr.every(function (fxinVal, fxinIdx, fxinArr) {

        for (let idx = fxinIdx + 1; idx < fxinArr.length; idx++) {
            if (fxinVal === fxinArr[idx]) {
                return false;
            }
        }
        return true;
...
function hasCertainKey(arr, key) {
    ...
    return arr.every(function (fxinObj) {
        return fxinObj[key] !== undefined;
    });
}
...
function hasCertainValue(arr, key, searchValue) {
    ...
    return arr.every(function (fxinObj) {
        return fxinObj[key] === searchValue;
    })
